...
class AppLayout extends React.Component {
  ...
  getTitle(title){
    ...
    this.setState({ titlePageTop : title});
  ...
  render() {
    ...
    return (
      <div>
        <main className=''>
          <Sidebar {...this.props} getTitle = {this.getTitle}/>
          <PageTop pagetitle = {this.state.titlePageTop} location={this.props.location} user={this.state.user} />
